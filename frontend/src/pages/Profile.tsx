        ...
        <Card sx={{ mb: 4, bgcolor: 'primary.50', border: '1px solid', borderColor: 'primary.200' }}>
          <CardContent>
            ...
            <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', sm: '1fr 1fr' }, gap: 1.5 }}>
              {[
                { label: 'Add Business Address', done: setupStatus.address, path: '/settings/profile' },
                { label: 'Add Phone Number', done: setupStatus.phone, path: '/settings/profile' },
                ...
                <Box 
                  ...
                  sx={{ 
                    ...
                    '&:hover': !task.done ? { bgcolor: 'action.hover' } : {},
                    transition: 'all 0.2s'
                  }}
                >
                  <Box sx={{ 
