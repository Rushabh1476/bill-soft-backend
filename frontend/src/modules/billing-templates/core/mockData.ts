import { TemplateField, TemplateSettings, InvoiceTemplate } from './index';
...
export const MOCK_TEMPLATES: InvoiceTemplate[] = [
    {
        ...
        fields: [
            { id: 'companyName', name: 'Company Name', label: 'Company Name', type: 'text', required: false, visible: true, position: 0 },
